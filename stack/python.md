...
Nível: iniciante. Scripts, listas, funções e leitura simples de dados. Uso para lógica e estudo de back.

Exemplo: calcular total de um pedido.
...
Arquivo: [exemplos/pedido.py](./exemplos/pedido.py)

Rodar localmente: `python stack/exemplos/pedido.py`
