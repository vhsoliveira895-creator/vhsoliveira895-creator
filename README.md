...
Meu caminho mistura **low-code** com front e back no nível de quem está começando: interface com **React**, lógica com **Python**, SQL e o dia a dia no **VS Code**. Uso IA para estudar, revisar código e destravar — não para fingir o que ainda não sei.

<div align="center">

[![GitHub followers](https://img.shields.io/github/followers/vhsoliveira895-creator?label=Seguidores&style=social)](https://github.com/vhsoliveira895-creator)
[![GitHub stars](https://img.shields.io/github/stars/vhsoliveira895-creator?style=social)](https://github.com/vhsoliveira895-creator)
...
- 📍 Fortaleza, Ceará
- 🧩 Low-code + web (front e back, nível iniciante)
- 📚 React, Python, JavaScript, SQL, Git e VS Code
- 🤖 IA como apoio de estudo e revisão de código
- 🚀 Aberto a estágio ou júnior (presencial, híbrido ou remoto)
...
- Praticando front (HTML, CSS, JavaScript, React)
- Praticando back (Python, SQL, APIs)
- Versionando no Git/GitHub
- Usando low-code para entregar mais rápido enquanto estudo o restante
- Ajustando os projetos que já estão prontos
...
> Iniciante, construindo de verdade e ajustando o que já está pronto.
